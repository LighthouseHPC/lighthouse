...
""" open routines/inverse_341.txt and make a list of the file names. """
inverseList_341 = []
f = open('./routines/inverse_341.txt')
for line in f:
    inverseList_341.append(line.strip('\r\n'))
    
print inverseList_341, len(inverseList_341)


resultFile = open("parameters_inverse.csv",'wb')
wr = csv.writer(resultFile, dialect='excel')
for infile in inverseList_341:
