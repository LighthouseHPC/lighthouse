...
print "----------------- Sort the eigen routines in v3.4.1 -----------------"
...
###------------ find eigen routines in v3.4.1 
wr_single = csv.writer(open('./routines/eigen_341_single.txt', 'w'), delimiter=';')
wr_double = csv.writer(open('./routines/eigen_341_double.txt', 'w'), delimiter=';')
wr_complex = csv.writer(open('./routines/eigen_341_complex.txt', 'w'), delimiter=';')
wr_complex16 = csv.writer(open('./routines/eigen_341_complex16.txt', 'w'), delimiter=';')
wr_aux = csv.writer(open('./routines/eigen_341_aux.txt', 'w'), delimiter=';')
