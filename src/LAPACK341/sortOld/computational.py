...
print "----------------- Sort the computational routines in the old version -----------------"


###------------ find computational routines in the old version 
wr_single = csv.writer(open('./routines/computational_old_single.txt', 'w'), delimiter=';')
wr_double = csv.writer(open('./routines/computational_old_double.txt', 'w'), delimiter=';')
wr_complex = csv.writer(open('./routines/computational_old_complex.txt', 'w'), delimiter=';')
wr_complex16 = csv.writer(open('./routines/computational_old_complex16.txt', 'w'), delimiter=';')
wr_aux = csv.writer(open('./routines/computational_old_aux.txt', 'w'), delimiter=';')
