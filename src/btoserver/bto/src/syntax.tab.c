...
{
       0,     0,     3,    14,    23,    32,    41,    45,    47,    51,
      53,    55,    56,    59,    62,    64,    65,    68,    72,    74,
      76,    80,    84,    88,    91,    94
};
...
{
      30,     0,    -1,    16,     5,    32,     6,    32,     7,    32,
      21,    35,    22,    -1,    16,     5,    32,     6,    32,    21,
      35,    22,    -1,    16,     6,    32,     7,    32,    21,    35,
      22,    -1,    16,     5,    32,     7,    32,    21,    35,    22,
      -1,    16,    23,    34,    -1,    31,    -1,    32,    24,    31,
      -1,     8,    -1,     9,    -1,    -1,    33,    11,    -1,    33,
      10,    -1,    12,    -1,    -1,    35,    36,    -1,    16,    25,
      37,    -1,    17,    -1,    16,    -1,    37,    19,    37,    -1,
      37,    18,    37,    -1,    37,    20,    37,    -1,    18,    37,
      -1,    37,    26,    -1,    27,    37,    28,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    55,    55,    57,    60,    63,    67,    69,    70,    73,
      74,    75,    83,    84,    85,    87,    88,    90,    92,    93,
      94,    95,    96,    97,    98,    99
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ROW", "COLUMN", "VECTOR", "MATRIX", "SCALAR", "GENERAL", "COORDINATE",
  "COMPRESSED", "VAR", "NUM", "'-'", "'+'", "'*'", "'{'", "'}'", "':'",
  "','", "'='", "'''", "'('", "')'", "$accept", "input", "param",
  "param_list", "orientation", "type", "prog", "stmt", "expr", 0
};
#endif
...
{
       0,     0,     0,     0,     0,     1,     0,     7,     0,     0,
      11,     0,     0,     0,     0,     9,    10,    14,     0,     6,
       0,     0,     8,     0,    13,    12,     0,    15,    15,    15,
       0,     0,     0,     0,    15,     0,     3,    16,     5,     4,
       0,     0,     2,    19,    18,     0,     0,    17,    23,     0,
       0,     0,     0,    24,    25,    21,    20,    22
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     7,     8,    18,    19,    31,    37,    47
};
...
{
     -11,    55,    13,     4,     4,   -18,     1,   -18,    -5,    -1,
      42,     4,     4,     4,     4,   -18,   -18,   -18,    22,   -18,
      -3,    28,   -18,    34,   -18,   -18,     4,   -18,   -18,   -18,
      35,   -13,    19,    24,   -18,    32,   -18,   -18,   -18,   -18,
      26,    -2,   -18,   -18,   -18,    -2,    -2,    11,    36,     8,
      -2,    -2,    -2,   -18,   -18,    27,    27,    36
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -18,   -18,    50,    -4,   -18,   -18,   -17,   -18,    -7
};
...
{
       9,    11,    12,    35,    26,     1,    14,    20,    21,    36,
      23,    32,    33,     5,    43,    44,    45,    40,    27,    13,
       6,    13,    30,    13,    10,    46,    50,    51,    52,    50,
      51,    52,    24,    25,    53,    35,    54,    53,    48,    49,
      35,    38,    35,    55,    56,    57,    39,    52,    42,    28,
      15,    16,    13,    53,    17,    29,    34,    41,    13,    13,
       3,     4,    53,    22
};

static const yytype_uint8 yycheck[] =
{
       4,     6,     7,    16,     7,    16,     7,    11,    12,    22,
      14,    28,    29,     0,    16,    17,    18,    34,    21,    24,
      16,    24,    26,    24,    23,    27,    18,    19,    20,    18,
      19,    20,    10,    11,    26,    16,    28,    26,    45,    46,
      16,    22,    16,    50,    51,    52,    22,    20,    22,    21,
       8,     9,    24,    26,    12,    21,    21,    25,    24,    24,
       5,     6,    26,    13
};
...
{
       0,    16,    30,     5,     6,     0,    16,    31,    32,    32,
      23,     6,     7,    24,     7,     8,     9,    12,    33,    34,
      32,    32,    31,    32,    10,    11,     7,    21,    21,    21,
      32,    35,    35,    35,    21,    16,    22,    36,    22,    22,
      35,    25,    22,    16,    17,    18,    27,    37,    37,    37,
      18,    19,    20,    26,    28,    37,    37,    37
};
...
#line 70 "syntax.y"
  ...
  case 9:
#line 73 "syntax.y"
    { (yyval.orien) = new std::string("row"); ;}
    break;

  case 10:
#line 74 "syntax.y"
    { (yyval.orien) = new std::string("column"); ;}
    break;
...
#line 75 "syntax.y"
  ...
  case 12:
#line 83 "syntax.y"
    { (yyval.value_type) = new type((yyvsp[(1) - (2)].orien), "matrix", dense); ;}
    break;

  case 13:
#line 84 "syntax.y"
    { (yyval.value_type) = new type((yyvsp[(1) - (2)].orien), "vector", dense); ;}
    break;
