...
Advanced_choices = (
	('Computational LinearEquation_computational', 'Computational Routines'),
	('Driver LinearEquation_simple', 'Simple Driver Routines'),
	('Driver LinearEquation_expert', 'Expert Driver Routines'),
)
...
LinearEquation_computational_choices = (
