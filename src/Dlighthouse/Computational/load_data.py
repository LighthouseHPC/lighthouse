...
nr_records_inserted = cursor.execute("LOAD DATA LOCAL INFILE '~/Documents/Lighthouse/Dlighthouse/Computational/le_computational_all.csv' INTO \
                                     TABLE Computational_linearequation_computational FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n'")


nr_records_inserted = cursor.execute("LOAD DATA LOCAL INFILE '~/Documents/Lighthouse/Dlighthouse/Computational/le_factor.csv' INTO \
                                     TABLE Computational_linearequation_factor FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n'")


nr_records_inserted = cursor.execute("LOAD DATA LOCAL INFILE '~/Documents/Lighthouse/Dlighthouse/Computational/le_solve.csv' INTO \
                                     TABLE Computational_linearequation_solve FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n'")


nr_records_inserted = cursor.execute("LOAD DATA LOCAL INFILE '~/Documents/Lighthouse/Dlighthouse/Computational/le_condition_number.csv' INTO \
                                     TABLE Computational_linearequation_condition_number FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n'")


nr_records_inserted = cursor.execute("LOAD DATA LOCAL INFILE '~/Documents/Lighthouse/Dlighthouse/Computational/le_error_bounds.csv' INTO \
                                     TABLE Computational_linearequation_error_bound FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n'")


nr_records_inserted = cursor.execute("LOAD DATA LOCAL INFILE '~/Documents/Lighthouse/Dlighthouse/Computational/le_invert.csv' INTO \
                                     TABLE Computational_linearequation_invert FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n'")


nr_records_inserted = cursor.execute("LOAD DATA LOCAL INFILE '~/Documents/Lighthouse/Dlighthouse/Computational/le_equilibrate.csv' INTO \
