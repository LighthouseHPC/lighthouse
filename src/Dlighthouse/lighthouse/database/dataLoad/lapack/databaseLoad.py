...
os.chdir(database_path+"/lapack_le/databaseMng/Driver")
os.system('python load_data.py')
os.chdir(database_path)
...
os.chdir(database_path+"/lapack_le/databaseMng/Computational")
os.system('python load_data.py')
os.chdir(database_path)
...
### load data to table
### lapack_le_only
os.chdir(database_path+"/lapack_le/databaseMng/Combine")
os.system('python load_data.py')
os.chdir(database_path)
...
### load data to table
### lapack_le_arg
os.chdir(database_path+"/lapack_le/databaseMng/Arguments")
os.system('python load_data.py')
os.chdir(database_path)
