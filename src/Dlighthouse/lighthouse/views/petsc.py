...
def linear_system(request):
	...
	if request.method == 'POST':
		...
		return render_to_response(
			'lighthouse/petsc/linear_system.html', 
			context_instance=RequestContext(request, context)
		)
...
def generateCode(request):
	...
	base_path = './lighthouse/libraries/petsc/work_dir/'
...
def downloadCode(request):
	...
	filepath = './lighthouse/libraries/petsc/work_dir/sample.zip'
...
def getCode():
	...
	filepath = './lighthouse/libraries/petsc/work_dir/linear_solver.c'
	code = ""
...
def getMakefile():
	...
	filepath = './lighthouse/libraries/petsc/work_dir/makefile'
	makefile = ""
...
def getCommands():
	...
	filepath = './lighthouse/libraries/petsc/work_dir/command_line_options.txt'
	commands = ""
...
def handle_uploaded_file(f):
    with open('./lighthouse/libraries/petsc/work_dir/'+'matrix_file', 'wb+') as destination:
