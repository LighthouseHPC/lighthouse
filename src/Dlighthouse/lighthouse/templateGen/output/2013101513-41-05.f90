        MODULE Declaration
            ...
            REAL(KIND=4)                                                 :: AMAX,SCOND, SMLNUM, BIGNUM
            REAL(kind=8)                                                :: SLAMCH
        ...
        PROGRAM TEMP_ssyequb
            USE Declaration
            IMPLICIT NONE
            
            !--- message ---!
            PRINT *, "********************************************"
            PRINT *, "*** Use ssyequb to equilibrate matrix A. ***"
            PRINT *, "********************************************"
            PRINT *,
            ...
            !--- call lapack subroutine ssyequb ---!
