...
../scripts/anamod2arff.py -f ../petsc/anamod-features -p ../petsc/timing/bgq -n solvers_anamod

* For TPetra (Trilinos) features + PETSc linear solvers:
../scripts/anamod2arff.py -T ../trilinos/tpetra_properties/12procs_results.csv -p ../petsc/timing/bgq -n solvers_tpetra
...
../scripts/anamod2arff.py -f ../petsc/anamod-features -B ../timing/janus-belos/belos_ifpack2_results.csv -n belos_anamod
