...
STANDARD_CHOICES = (
        (u'standard',                   	u'Standard linear least squares problem with a general matrix'),
        (u'generalized',                	u'Generalized linear least squares problem with a general matrix'), 
)
...
GFULLRANK_CHOICES = (
        (u'B_Full_Row',                 	u'linear equality-constrained least squares problem (LSE) (min|c-Ax| subject to Bx=d)'), 
        (u'A_Full_Col',                 	u'general (Gauss-Markov) linear model problem (GLM)(min|y| subject to d=Ax+By)'), 
)
