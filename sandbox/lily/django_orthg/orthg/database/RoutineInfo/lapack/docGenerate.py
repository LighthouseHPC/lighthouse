...
import MySQLdb
import os
dirOrthgProject = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))))
...
reader = csv.reader(open(dirOrthgProject+"/django_orthg/static/Doxygen/url.csv"))
