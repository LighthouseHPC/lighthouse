...
public class CsvComparison {
	...
	void read() {
		...
		fileOne = read(
				"/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/3classlabelling/MatrixNameWithFeatVal3class_40.csv",
				true);
		System.out.println("File size-------------------------------------"
				+ fileOne.size());
		
		fileTwo = read(
				"/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/3classlabelling/AllFeat/RFmispredicted_3labels21505.csv",
				false);
		//fileTwo = read(
			//	"/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/mispredicted_big21505.csv",
				//false); //working
	...
	List<RowObject> read(String filename, boolean lastTwo) {
		try {
			...
			while (features.readRecord()) {
				...
				row.id(features.get(69));
				//System.out.println(features.get(69));
				row.classlabel(features.get(72));
	...
	void write() {
		...
		try {
			...
			String file = "/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/3classlabelling/combined21505_3class.csv";
			...
			CsvReader features = new CsvReader(
					"/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/WekaGeneratedArff/MatrixNameWithFeatValFeb22_WG.csv");
			features.readHeaders();
			...
			for (RowObject rowFileTwo : fileTwo) {
				for (RowObject rowFileOne : fileOne) {
					if (rowFileOne.equals(rowFileTwo)) {
						...
						System.out.println(rowFileOne.classlabel);
