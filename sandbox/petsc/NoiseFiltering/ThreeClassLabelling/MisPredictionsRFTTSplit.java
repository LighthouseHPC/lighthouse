...
public class MisPredictionsRFTTSplit {
	
	public static void main(String[] args) throws Exception {
		BufferedReader datafile = readDataFile("/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/3classlabelling/solvers_anamod_25_40.arff");		
		...
		BufferedWriter writer = new BufferedWriter(new FileWriter("/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/3classlabelling/AllFeat/RFmispredicted_3labels21505.csv"));
		for(int j=0; j < DataSet.numInstances();j++){  
		            ...
		            if(prediction == 0.0 && actual == 1.0 || prediction == 0.0 && actual == 2.0 || prediction == 1.0 && actual == 0.0 || prediction == 1.0 && actual == 2.0 || prediction == 2.0 && actual == 1.0 || prediction == 2.0 && actual == 0.0){
		            	mispredictions++;
		            	//DataSet.instance(j).		          
		            	writer.write(DataSet.instance(j).toString()); // it writes the actual label in the writer file
		            	writer.newLine();
