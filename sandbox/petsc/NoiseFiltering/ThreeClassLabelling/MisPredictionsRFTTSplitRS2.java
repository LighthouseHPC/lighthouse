...
public class MisPredictionsRFTTSplitRS2 {
	...
	public static void main(String[] args) throws Exception {
		...
		BufferedWriter writer = new BufferedWriter(new FileWriter("/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/3classlabelling/RS2/RFmispredicted_3labels21505_RS2.csv"));
		for(int j=0; j < DataSet.numInstances();j++){  
		            ...
		            if(prediction == 0.0 && actual == 1.0 || prediction == 0.0 && actual == 2.0 || prediction == 1.0 && actual == 0.0 || prediction == 1.0 && actual == 2.0 || prediction == 2.0 && actual == 1.0 || prediction == 2.0 && actual == 0.0){
		            	mispredictions++;
		            	//DataSet.instance(j).
		            	System.out.println(DataSet.instance(j).toString());
