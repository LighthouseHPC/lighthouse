...
public class CsvComparisonRS1 {
	...
	void read() {
		...
		fileOne = read(
				"/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/3classlabelling/RS1/MatrixNameWithFeatVal3class_40RS1.csv",
				true);
		System.out.println("File size-------------------------------------"
				+ fileOne.size());
		
		fileTwo = read(
				"/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/3classlabelling/RS1/RFmispredicted_3labels21505_RS1.csv",
				false);
		//fileTwo = read(
	...
	List<RowObject> read(String filename, boolean lastTwo) {
		try {
			...
			while (features.readRecord()) {
				...
				row.id(features.get(9));
				row.classlabel(features.get(12));
	...
	void write() {
		...
		try {
			...
			String file = "/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/3classlabelling/RS1/RFRS1combined21505_feb22.csv";
