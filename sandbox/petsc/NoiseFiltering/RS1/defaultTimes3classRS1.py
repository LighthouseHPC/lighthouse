...
with open('/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/RS1/RFRS1combined21505_feb22.csv', 'r+') as csvinput:
#with open('/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/combined21505_feb22.csv', 'r+') as csvinput:
		...
		csvoutput = '/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/RF/RS1default_Time.csv'
...
with open('/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/RF/RS1default_Time.csv', 'r+') as csvinput:
		infile = csv.reader(csvinput)
		csvoutput = '/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/TimeComparison/MisPredictedDataPoints/RF/RS1TimeComparisonWithDefault.csv'
...
with open('/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/TimeComparison/MisPredictedDataPoints/RF/RS1TimeComparisonWithDefault.csv', 'r+') as csvinput:
		infile = csv.reader(csvinput)
		csvoutput = '/Users/kanikas/Desktop/Feb22_MisPredictionAnalysis/TimeComparison/MisPredictedDataPoints/RF/RS1TimeComparisonWithDefaultForGood.csv'
		with open(csvoutput,'w') as csvout:
			writer = csv.writer(csvout)
			infile = csv.reader(csvinput)
			writer.writerow(header + ['default_time'] + ['Time Difference'] + ['Comparison'] + ['SpeedUp'])
